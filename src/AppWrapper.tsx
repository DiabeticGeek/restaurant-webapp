    ...
    <DndProvider backend={HTML5Backend}>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          {/* Server, Kitchen, Bar Routes */}
          <Route element={<ProtectedRoute allowedRoles={['owner', 'server']} />}><Route path="/server" element={<ServerView />} /></Route>
          <Route element={<ProtectedRoute allowedRoles={['owner', 'kitchen']} />}><Route path="/kitchen" element={<KitchenDisplay />} /></Route>
          <Route element={<ProtectedRoute allowedRoles={['owner', 'bar']} />}><Route path="/bar" element={<BarDisplay />} /></Route>
        </Route>
